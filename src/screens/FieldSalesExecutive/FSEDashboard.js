...
const FSEDashboard = ({ navigation }) => {
  ...
  // Pending / Approved / Rejected Retailer onboarding-request counts
  // (scoped to this FSE's hierarchy on the server).
  const {
    ...
    <View style={FSEDashboardStyle.container}>
      ...
      <ScrollView>
        <View style={FSEDashboardStyle.content}>
          ...
          <Text style={FSEDashboardStyle.sectionTitle}>
          ...
          <ApprovalStatusCards
            ...
            loading={approvalCountsLoading}
            error={approvalCountsError}
            onPress={() => navigation.navigate('FSEApprovalScreen')}
          />
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('FSEApprovalScreen')}
          >
            <UserCheck size={20} color="#6A1B9A" />
            <Text style={FSEDashboardStyle.actionText}>Retailer Approvals</Text>
          </TouchableOpacity>
